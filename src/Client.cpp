...
/*   Updated: 2025/09/09 20:45:18 by asoumare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void change_username(Client &clients, std::string user, Client &client) // a refaire
{
    ...
    else // :Welcome to the IRC server <nick>!<user>@<host>
    {
